...
<html>
    <head>
        ...
        <title>Consultar Institucion</title>
            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <h1 class="text-white-50 mx-auto mt-2 mb-2">Institucion <%out.println(request.getParameter("nameSalud")); %></h1>
                        <p class="text-white-50 mx-auto mt-2 mb-2">
                            ...
                            <%    
                          Base ba=new Base();
                               out.println(ba.institution(request.getParameter("nameSalud"))); 
                            %>
                        </p>
                    </div>
                </div>
